...
; CHECK-NEXT:    [[TMP1:%.*]] = mul <4 x i32> [[TMP0]], <i32 2, i32 0, i32 2, i32 1>
; CHECK-NEXT:    [[TMP2:%.*]] = add <4 x i32> [[TMP0]], <i32 2, i32 0, i32 2, i32 1>
; CHECK-NEXT:    [[TMP3:%.*]] = shufflevector <4 x i32> [[TMP1]], <4 x i32> [[TMP2]], <4 x i32> <i32 0, i32 5, i32 2, i32 3>
